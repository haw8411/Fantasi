...
#define BE_USE_SOLIDIFY_MODULE          0   /* Fantasi: dev-only (Berry->C); ~13.6 KB flash, useless on-device */
 ...
 **/
/* Fantasi firmware port: route allocation to the FreeRTOS heap (heap_4 has no
 * realloc, so fantasi_be_realloc size-tracks) and abort/exit to a fatal handler.
 * Defined in core/berry_host.c. */
...
#define BE_EXPLICIT_ABORT               fantasi_be_abort
#define BE_EXPLICIT_EXIT(code)          fantasi_be_abort()
#define BE_EXPLICIT_MALLOC              fantasi_be_malloc
#define BE_EXPLICIT_FREE                fantasi_be_free
#define BE_EXPLICIT_REALLOC             fantasi_be_realloc
